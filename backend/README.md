...
## Project Structure
    ...
    ├── test_new_mobile_app_45897  # Django project configurations
...
1. Clone this repo and `cd test_new_mobile_app_45897`
...
2. Clone this repo and `cd test_new_mobile_app_45897`
